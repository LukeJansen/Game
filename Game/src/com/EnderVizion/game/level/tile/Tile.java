...
public class Tile {
	...
	public static Tile grass_flower_red = new FlowerTile(Sprite.grass_flower_red);
	public static Tile grass_flower_yellow = new FlowerTile(Sprite.grass_flower_yellow);
